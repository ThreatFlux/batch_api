...
class DataProcessor:
    ...
    def load_csv(self, file_path: Path, file_type: str) -> None:
        ...
        try:
            ...
            if file_type == "mitre":
                ...
                self.audit_data = df
                self.audit_data = df
            logger.info("Successfully loaded %s data from %s", file_type, file_path)
    ...
    def get_related_techniques(self, technique_id: str) -> List[Tuple[str, float]]:
        ...
        # Initialize list for related techniques
    ...
    def get_technique_groups(self) -> List[List[str]]:
        ...
        if not self.correlation_matrix:
            return []
        # Initialize groups and processed set
        groups: List[List[str]] = []
        processed: set = set()
        # Iterate through techniques and group them
